...
file1= URI.open("https://static.wikia.nocookie.net/disney/images/1/11/Main_hall.JPG/revision/latest/scale-to-width-down/1000?cb=.jpg")
...
lair1.photo.attach(io: file1, filename: "ursula_lair", content_type: "image/jpg")
lair1.save
...
# lair3.photo.attach(io: file3, filename: "gaston_tavern", content_type: "image/jpg")
# lair3.save
...
# lair4.photo.attach(io: file4, filename: "jafar_lair", content_type: "image/jpg")
# lair4.save
...
# lair5.photo.attach(io: file5, filename: "morgana_ice_cave", content_type: "image/jpg")
# lair5.save
...
# lair6.photo.attach(io: file6, filename: "spirit_of_adventure", content_type: "image/jpg")
# lair6.save
...
# lair7.photo.attach(io: file7, filename: "cassandras_stronghold", content_type: "image/jpg")
# lair7.save
...
# lair8.photo.attach(io: file8, filename: "sid_house", content_type: "image/jpg")
# lair8.save
...
# lair9.photo.attach(io: file9, filename: "ratigan", content_type: "image/jpg")
# lair9.save
...
# lair10.photo.attach(io: file10, filename: "cinderella", content_type: "image/jpg")
# lair10.save
...
# lair11.photo.attach(io: file11, filename: "rapunzel_tower", content_type: "image/png")
# lair11.save
...
# lair12.photo.attach(io: file12, filename: "snow_white", content_type: "image/png")
# lair12.save
...
# lair13.photo.attach(io: file13, filename: "doofenschmirtz", content_type: "image/jpg")
# lair13.save
...
# lair14.photo.attach(io: file14, filename: "scar_lair", content_type: "image/jpg")
# lair14.save
...
# lair15.photo.attach(io: file15, filename: "maleficent", content_type: "image/jpg")
# lair15.save

puts "#{Lair.count} users created! 🪄🧞‍♂️"
